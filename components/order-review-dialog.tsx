    ...
    >
      ...
      >
        ...
        <dl>
          <div>
            <dt>Venue</dt>
            <dd>{order.venue.toUpperCase()}</dd>
          </div>
          <div>
            <dt>Target direction</dt>
            <dd>{targetSide.toUpperCase()}</dd>
          </div>
          <div>
            <dt>Your inverse</dt>
            <dd>
          ...
          <div>
            <dt>USD notional</dt>
            <dd>${order.requestedNotionalUsd}</dd>
          </div>
          <div>
            <dt>Estimated amount</dt>
            <dd>
              {order.estimatedBaseAmount} {order.symbol}
            </dd>
          </div>
          <div>
            <dt>Order type</dt>
            <dd>
              {order.venue === 'nado' ? 'IOC aggressive limit' : 'Market'}
            </dd>
          </div>
          <div>
            <dt>Reduce only</dt>
            <dd>{order.reduceOnly ? 'Yes' : 'No'}</dd>
          </div>
          <div>
            <dt>Slippage</dt>
            <dd>{slippageBps} bps</dd>
          </div>
        </dl>
        <div className="review-warning">
          The final execution price may differ. Your wallet will show the
        ...
        <div className="dialog-actions">
          ...
          <button
            ...
            disabled={pending}
          >
            {pending ? 'Working…' : 'Confirm and sign'}
          </button>
        </div>
      </section>
    </div>
